...
export default async function StaffRequestsPage() {
  ...
  const [leave, claims, attendance, approvals] = await Promise.all([
  ...
  return (
    <section className="staff-hub-page" aria-labelledby="staff-requests-heading">
      ...
      {enabledModules.has("HR") ? (
        <div className="staff-hub-note"><strong>Overtime</strong><span>Overtime is calculated from approved attendance. There is no separate OT request in the current canonical workflow.</span></div>
      ) : null}
