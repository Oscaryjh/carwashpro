...
export default async function StaffPayPage() {
  ...
  return (
    <section className="staff-hub-page" aria-labelledby="staff-pay-heading">
      ...
      {enabledModules.has("PAYROLL") ? (
        latestPayslip ? (
          <article className="staff-pay-summary" aria-label="Latest published payslip">
          ...
          <div className="staff-empty-state staff-pay-empty" role="status">
            ...
            <h2>No payslip published yet</h2>
            <p>Your latest pay summary will appear here after your employer publishes it.</p>
          </div>
        )
      ) : null}
