...
const payrollCapabilityPermissions = [
  ...
  ["VIEW_BANK_ACCOUNT", "View employee bank profiles (not available yet)"],
  ["EDIT_BANK_ACCOUNT", "Edit employee bank profiles (not available yet)"],
  ["VERIFY_BANK_ACCOUNT", "Verify employee bank profiles (foundation only)"],
  ["VIEW_PAYMENT_BATCH", "View payment batches (not available yet)"],
  ["PROCESS_PAYMENT", "Process payroll payments (not available yet)"],
  ["CREATE_PAYMENT_BATCH", "Create payroll payment batches (foundation only)"],
  ["SUBMIT_PAYMENT_BATCH", "Submit payroll payment batches (foundation only)"],
  ["APPROVE_PAYMENT_BATCH", "Approve payroll payment batches (foundation only)"],
  ["EXPORT_PAYMENT_FILE", "Export bank payment files (not available yet)"],
  ["CANCEL_PAYMENT_BATCH", "Cancel payroll payment batches (foundation only)"],
  ["VIEW_PAYMENT_AUDIT", "View payroll payment audit history (foundation only)"],
