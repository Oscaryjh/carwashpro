...
截图：[schedule-v2-390x844.png](artifacts/staff-schedule-v2/schedule-v2-390x844.png)

## 17. MOBILE 412

PASS。412×915 实测 `scrollWidth === innerWidth`，DOM/层级与 390 相同，没有放大卡片或增加多余空白。

截图：[schedule-v2-412x915.png](artifacts/staff-schedule-v2/schedule-v2-412x915.png)
